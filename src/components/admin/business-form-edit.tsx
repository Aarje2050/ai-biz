/**
 * File: src/components/admin/business-edit-form.tsx
 * 
 * Form for business owners to edit business information
 */
'use client'
...
interface BusinessFormEditProps {
  business: Business
}

export function BusinessFormEdit({ business }: BusinessFormEditProps) {
